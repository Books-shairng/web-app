...
-- ################################################# HISTORY TABLE
INSERT INTO HISTORY (id, RETURN_DATE, ACTIVE, BOOK_ID, USER_ID) VALUES (1, '2017-01-31', TRUE, 1, 1)

-- ################################################# HISTORY TABLE
INSERT INTO COMMENT (id, CONTENT, ACTIVE, BOOK_ID, USER_ID) VALUES (1, 'any comment content', TRUE, 1, 1)
