...
-- ################################################# BORROW TABLE
INSERT INTO BORROW (id, BORROW_DATE, RETURN_DATE,CAN_EXTEND_RETURN_DATE, ACTIVE) VALUES (1, '2017-01-01', '2017-01-31', TRUE, TRUE)

-- ################################################# HISTORY TABLE
INSERT INTO HISTORY (id, BORROW_DATE, RETURN_DATE, ACTIVE) VALUES (1, '2017-01-01', '2017-01-31', TRUE)