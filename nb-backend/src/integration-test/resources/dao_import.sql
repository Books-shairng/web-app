...
-- ################################################# BOOK TABLE
INSERT INTO BOOK (id, TITLE, AUTHOR, ISBN, ACTIVE, STATUS, DESCRIPTION) VALUES (1, 	'Effective Java', 'J. Bloch', '978-0321356680', TRUE, 'FREE', 'desc')

-- ################################################# ORDER DATE TABLE
INSERT INTO QUEUE (ID, ORDER_DATE, ACTIVE) VALUES (1, '2017-03-21 08:17:00', TRUE)

-- ################################################# BORROW TABLE
INSERT INTO BORROW (id, BORROW_DATE, EXPECTED_RETURN_DATE, REAL_RETURN_DATE, CAN_EXTEND_RETURN_DATE, ACTIVE) VALUES (1, '2017-01-01', '2017-01-31', '2017-02-01', TRUE, TRUE)
